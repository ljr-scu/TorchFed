...
if __name__ == '__main__':
    # argparse 模块创建了一个命令行解析器（ArgumentParser）的实例
    # description 参数用于提供一个简短的程序描述
    parser = argparse.ArgumentParser(description='Simulation of FedAvg')

    # parser.add_argument 是用于定义命令行参数的方法,这里是添加一个整数类型的命令行参数
    # help参数： 提供对参数的简要描述，这个描述通常会在用户请求帮助信息时显示
    parser.add_argument(
        '--world_size',
        type=int,
